package cn.edu.gdmec.s07150723.camerademo;
...
public class MainActivity extends AppCompatActivity implements  SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        android.hardware.Camera.Parameters paarms = camera.getParameters();
        paarms.setFocusMode(android.hardware.Camera.Parameters.FOCUS_MODE_AUTO);
    }
